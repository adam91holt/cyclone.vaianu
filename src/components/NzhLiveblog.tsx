...
import { useNzhLiveblog } from '@/hooks/useNzhLiveblog'
...
export function NzhLiveblog() {
  const { data: posts, isLoading } = useNzhLiveblog(15)

  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#12202e]/90 via-[#0e1a28]/90 to-[#0a1420]/90 border border-white/10 backdrop-blur-sm">
      {/* Header bar */}
      <div className="relative px-5 py-4 border-b border-white/10 flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-lg bg-sky-500/20 border border-sky-500/40">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1 text-[9px] font-mono uppercase tracking-wider text-sky-200/70 bg-sky-500/10 border border-sky-500/30 rounded-sm px-1.5 py-0.5">
      ...
      <div className="relative max-h-[720px] overflow-y-auto">
        ...
        {posts && posts.length > 0 && (
          <ol className="relative">
            ...
            <div className="absolute left-[34px] top-6 bottom-6 w-px bg-gradient-to-b from-sky-500/40 via-white/10 to-transparent" />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                    {isLatest && (
                      <span className="text-[9px] font-bold uppercase tracking-[0.18em] px-1.5 py-0.5 rounded-sm bg-sky-500/20 text-sky-300 border border-sky-500/40">
                        Latest
                      </span>
                    )}
