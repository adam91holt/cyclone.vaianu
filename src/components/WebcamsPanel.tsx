  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-[#0f1729]/80 border border-white/10 backdrop-blur-sm p-5">
      ...
      <p className="mt-4 text-[10px] text-white/40 leading-relaxed">
        Live HLS streams from CoroLive's Coromandel webcam network. All three
        cameras sit inside the RED-warning landfall zone and update in real time.
        Other NZ webcam sources were checked and excluded because their feeds
        are currently stale or dormant.
      </p>
    </div>
  )
}
